...
Either<ValueFailure<String>, String> validateCountryCode(String input) {
  if (input.length >= 2) {
    ...
    return left(
      ValueFailure.invalidCountryCode(failureValue: input),
    );
  }
}
...
Either<ValueFailure<String>, String> validateVerificationCode(String input) {
  if (input.length >= 4) {
    ...
    return left(
      ValueFailure.invalidVerificationCode(failureValue: input),
    );
  }
}
...
Either<ValueFailure<DateTime>, DateTime> validateDateTime(DateTime input) {
